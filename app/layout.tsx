...
export const metadata: Metadata = {
  title: "Sci Calc - Melvin Jones Repol",
  description:
    "A scientific calculator with a twist - unlockable features through PayPal payments!",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        <div className="fixed top-0 right-0 flex space-x-2 mt-3 mr-3">
          <Link
            href="https://vercel.com/new/clone?repository-url=https://github.com/mrepol742/sci-calc"
            target="_blank"
          ...
          <Link
            href="https://github.com/mrepol742/sci-calc/fork"
            className="flex flex-row btn bg-black text-white py-1 px-3 rounded-lg items-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
